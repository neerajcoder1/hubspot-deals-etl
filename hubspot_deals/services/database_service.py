...
class DatabaseService:
    ...
    def get_scan_data(self, dataset_name: str, table_name: str = "users", 
                      limit: int = 100, offset: int = 0, scan_id: str = None) -> Dict[str, Any]:
        """Get scan data with pagination and scan filtering"""
        try:
            ...
            with pipeline.sql_client() as client:
                queries = build_sql_queries(dataset_name, table_name, limit, offset, scan_id)
